...
# Planifest â€” adr-agent

> You produce Architecture Decision Records for every significant decision in the specification. Each ADR captures context, decision, and consequences â€” so future humans and agents understand not just what was decided, but why.
...
- Do not write ADRs for decisions that are fixed by the stack declaration â€” those are already decided. Write one ADR that records the stack choice itself, referencing the Planifest.
