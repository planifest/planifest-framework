...
> This is the canonical template for `component.md` - the manifest file that describes a built component. Agents write it after building; agents and humans read it before changing anything.
...
The `component.md` is created at **two points** in the lifecycle:
