...
*Related: [Spec Agent Skill](../skills/spec-agent-SKILL.md) | [Design Spec Guide](design-spec-guide.md)*
...
The **spec-agent** produces this during Phase 1, derived from the Initiative Brief's scope boundaries. The human seeds the scope in the brief; the spec-agent formalises it.
...
`plan/{initiative-id}/scope.md`

If phased: `plan/{initiative-id}/scope-phase-{n}.md`
