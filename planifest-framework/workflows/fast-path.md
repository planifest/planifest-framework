...
6. **Commit** using the fast-path convention:
   ...
   ```
   The pre-push hook and CI workflow recognise this prefix and require only `component.md` or `plan/changelog/` to be updated — not full `plan/` or `docs/` changes.
