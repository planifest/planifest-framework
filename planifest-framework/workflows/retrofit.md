...
- Component manifests (`component.md`) in each existing component - use the [component manifest template](../templates/component.template.md) and [guide](../templates/component-guide.md)
