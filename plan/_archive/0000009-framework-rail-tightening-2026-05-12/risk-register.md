...
|----|----------|------|-----------|--------|------------|
| R-001 | Technical | Open-source skills found via web search have ambiguous, mixed, or non-permissive licences | Medium | Low | Exclude any skill without a clearly identified permissive licence; library ships smaller but clean |
