...
- Version bumped 0.25.0 → 0.26.0 → 0.26.1 (minor, human's explicit choice at ship, then a same-branch fast-follow patch once the missing ADR/migration trail was caught) rather than the patch bump originally planned at PC.
